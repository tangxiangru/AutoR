...
applies_when: \b(synthesi[sz]\w*|manufactur\w*|de novo design|wet[-\s]?lab|in\s+vivo|in\s+vitro|experimentally|experimental (?:validation|verification|measurement|characteri[sz]ation))\b
