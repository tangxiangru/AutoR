...
the same two renderers the solo reviewer calls rather than a second copy of the wording.
...
class ReviewPanel:
    ...
    def _attach_ledger_positions(
        ...
        if not carried and not settled:
            return decision
        return replace(decision, carry_forward=carried, discharged=settled)
