...
2. **Shape.** A skill may carry an `applies_when` regex, matched against this run's own research
   brief and data manifest. Forty-seven skills are scoped this way today; measured over the forty
